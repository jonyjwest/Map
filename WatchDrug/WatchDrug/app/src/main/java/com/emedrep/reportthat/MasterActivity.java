...
import com.emedrep.reportthat.SyncHelper.ReportSyncAdapter;
...
public class MasterActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      // setTitle(" Report That!");
       ...
       ReportSyncAdapter.initializeSynAdapter(this);
        ...
        {
            Intent mServiceIntent = new Intent(this, PendingReportService.class);
