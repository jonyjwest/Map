    ...
    SharedPreferences pre;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            ...
            View v = inflater.inflate(R.layout.fragment_visited_location, container, false);
             pre=getActivity().getSharedPreferences(Constant.PREFERENCE_NAME, 0);
           ...
           if(pre.getString("fabVisitedLocation",null)!=null) {
               Tooltip.make(getActivity(),
                       new Tooltip.Builder(101)
                               ...
                               .activateDelay(900)
                               .showDelay(400)
                               .text("When you are within vendor's  premises, click here to register the place.")
                               .maxWidth(600)
                               .withArrow(true)
                               .withOverlay(true).build()
               ).show();
               Utilities.clearPreference(getActivity(),"fabVisitedLocation");
           }
            return v;
        }
