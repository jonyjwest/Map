...
public class VisitDataSource {
 ...
 public static final String VISIT_CREATE = "create table " + TBL_VISIT + "(" + COL_VISIT_ID + " integer primary key autoincrement," + COL_STATEID + " integer," + COL_LGAID + " integer," + COL_TYPE + " integer," + COL_NAME + " text," + COL_ADDRESS + " text," + COL_LATITUDE + " text," + COL_LONGITUDE + " text," + COL_DATE + " text)";

 private SQLiteDatabase database;
 private DataBaseHandler dbHelper;

 String[] allColumns = {COL_VISIT_ID, COL_STATEID, COL_LGAID, COL_TYPE, COL_NAME, COL_ADDRESS, COL_LATITUDE, COL_LONGITUDE, COL_DATE};
 ...
 public long createVisit(int stateId, int lgaId, int type, String name, String address, String latitude, String longitude, String date) {
