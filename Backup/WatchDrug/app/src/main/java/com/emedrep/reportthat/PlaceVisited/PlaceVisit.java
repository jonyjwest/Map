    ...
    public void onClick(View v) {
        if (v == imgRefresh) {
            ...
            if (!validate()) {
                ...
                long success = visitDataSource.createVisit(selectedState.getValue(),selectedLGA.getValue(),selectedType.getValue(),edtName.getText().toString(), edtDescription.getText().toString(), latValue, longValue, timeStamp);
